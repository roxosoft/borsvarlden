...
namespace borsvarlden.Services.Facebook
{
    ...
    public class FacebookService : IFacebookService
    {
        ...
        public FacebookService(IConfigurationHelper configurationHelper)
        {
            _accessToken = configurationHelper.FaceBookAccessToken;
            _pageID = configurationHelper.FaceBookPageId;
